  ...
  return (
    ...
    <section className="bg-black py-20">
      <div className="custom-container">
        <h1 className="text-green-600 text-center text-[60px] font-[700]">About Us</h1>
        <div className="!mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center !mb-16">
            ...
            <p className="text-neutral-400 text-lg max-w-2xl !mx-auto">
              Pakistan's premier manufacturer of premium aluminium foil products,
          ...
          <div className="!mt-24 grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              stat.animated ? (
                <SlotCounter key={index} value={stat.number} label={stat.label} />
              ) : (
          ...
          <div className="!mt-24 bg-neutral-900 rounded-2xl p-12 text-center">
            <h3 className="text-3xl md:text-4xl font-bold text-white !mb-4">
              Ready to Experience the <span className="text-green-600">Peky</span>{" "}
              Difference?
            </h3>
            ...
            <Link href='/buy' className="bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-4 rounded-lg transition-colors duration-300">
              Buy Our Product
            </Link>
          </div>
        </div>
