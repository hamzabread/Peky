...
export default function MeetTheDeveloper() {
  ...
  const skills = {
    'Programming Languages': ['C#', 'JavaScript (ES6+)', 'Python', 'C++', 'SQL (Postgres)'],
    'Frameworks & Libraries': ['.NET Core', 'ASP.NET Web API', 'React', 'Next.js', 'FastAPI', 'Flask', 'MERN Stack'],
    'Tools & Methodologies': ['Agile Development', 'ORM', 'Docker', 'Git', 'AWS', 'MQTT', 'Microservices'],
    'Core Competencies': ['Technical Leadership', 'System Architecture', 'Full-Stack Development', 'Data Persistence']
  };
  ...
  const projects = [
    {
      ...
      description: 'Engineered a full-stack authentication system with AWS Cognito, yielding a 20% increase in secure registration throughput. Optimized user conversion by 12% through Server-Side Rendering (SSR).',
    ...
    },
    {
      ...
      description: 'Architected a real-time IoT backend using ORM via EF Core, reducing data persistence latency by 25%. Secured 99.9% system uptime.',
    ...
    },
    {
      ...
      description: 'Developed a live-streaming platform supporting 50+ concurrent participants via Zoom SDK with zero session interruptions.',
    ...
    },
    {
      ...
      description: 'Constructed a computer vision pipeline achieving 92% identity detection accuracy. Reduced manual entry time by 80%.',
            ...
            <div className="max-w-7xl !mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="!mt-16 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-green-600 font-semibold">Software Developer</p>
                  
                  <div className="space-y-4 text-neutral-300">
                    <p className="text-lg leading-relaxed">
                      Software Developer and Computer Science student at GIKI, focused on Information Technology and Computer Engineering. 
                      Specialized in developing scalable web and IoT solutions using modern programming languages in Agile development environments.
                    </p>
                    <p className="text-lg leading-relaxed">
                      Technical expertise includes system architecture and data-driven optimization of engineering workflows.
                    </p>
                  </div>
              ...
              <div className="education-card bg-black rounded-2xl p-8 border border-neutral-800">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-neutral-400">Sep 2023 – May 2027 | Swabi, Pakistan</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-7xl !mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                {experience.map((exp, index) => (
                  <div key={index} className="exp-card bg-neutral-900 rounded-2xl p-8 border border-neutral-800 hover:border-green-600/50 transition-colors">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between !mb-4">
                      <div>
                        <h3 className="text-2xl font-bold text-white !mb-1">{exp.title}</h3>
                        <p className="text-green-600 font-semibold">{exp.company} • {exp.type}</p>
                      </div>
                      <span className="text-neutral-400 !mt-2 md:!mt-0">{exp.period}</span>
                    </div>
            ...
            <div className="max-w-7xl !mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {Object.entries(skills).map(([category, items], index) => (
                  <div key={index} className="skill-card bg-black rounded-2xl p-8 border border-neutral-800 hover:border-green-600/50 transition-colors">
            ...
            <div className="max-w-7xl !mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {projects.map((project, index) => (
                  <div key={index} className="project-card bg-neutral-900 rounded-2xl p-8 border border-neutral-800 hover:border-green-600/50 transition-all hover:shadow-lg hover:shadow-green-600/10">
                    <div className="text-4xl !mb-4">{project.icon}</div>
                    <h3 className="text-2xl font-bold text-white !mb-2">{project.title}</h3>
                    <p className="text-green-600 text-sm font-semibold !mb-4">{project.tech}</p>
