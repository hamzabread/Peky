...
const Footer = () => {
  return (
    <section className="bg-neutral-900 text-[#FFF] p-[50px] py-[60px]">
      <div className="flex flex-col lg:flex-row items-center gap-[40px]">
        ...
        <div className="flex flex-col w-full items-center lg:items-start">
          ...
          <Link
            ...
            className="bg-green-700 text-white px-[20px] py-[10px] rounded mt-[20px] hover:bg-green-800 transition"
          >
